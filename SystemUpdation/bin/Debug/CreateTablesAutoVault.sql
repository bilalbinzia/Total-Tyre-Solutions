...
ALTER TABLE [dbo].[Warehouse]  WITH CHECK ADD  CONSTRAINT [FK_Warehouse_ZipCode] FOREIGN KEY([ZipCodeID])
...
ALTER TABLE [dbo].[Customer]  WITH CHECK ADD  CONSTRAINT [FK_Customer_ZipCode] FOREIGN KEY([ZipCodeID])
REFERENCES [dbo].[ZipCode] ([ID])
GO
...
ALTER TABLE [dbo].[Customer]  WITH CHECK ADD  CONSTRAINT [FK_Customer_ZipCode1] FOREIGN KEY([ShippingZipCodeID])
REFERENCES [dbo].[ZipCode] ([ID])
GO
