...
{
    public partial class BaseControl : OperationalControl
    {
        //------------------------------------------
        ...
        void BaseControl_Load(object sender, EventArgs e)
        {
            ...
            //this.btnBNAddItem.Enabled = this.btnBNAddItemIsVisible;
            //this.btnBNEditItem.Enabled = this.btnBNEditItemIsVisible;
            //this.btnBNDeleteItem.Enabled = this.btnBNDeleteItemIsVisible;
            //this.btnBNSaveItem.Enabled = this.btnBNSaveItemIsVisible;
            //this.btnBNCancelItem.Enabled = this.btnBNCancelItemIsVisible;
            //this.btnBNRefresh.Enabled = this.btnBNRefreshIsVisible;
        ...
        {
            this.frmStatus = currentStatus.Add;
            base.objBindingSource.AddNew();
        ...
        {
            this.frmStatus = currentStatus.Edit;
        ...
        private void EnableDisableByUserLevel()
        {
            ...
            else if ((_loading) && (_reporting) && (_adding) && (_editing) && (!_deleting))
            {
                ...
                if (this.btnBNAddItemIsVisible)
                    this.btnBNAddItem.Enabled = true;
                if (this.btnBNEditItemIsVisible)
                    this.btnBNEditItem.Enabled = true;
                if (this.btnBNDeleteItemIsVisible)
        ...
        public void BaseEnableDisble(currentStatus frmCS)
        {
            if (frmCS == currentStatus.Add || frmCS == currentStatus.Edit)
            {
                //------------------------------------------------
                ...
                if (this.btnBNSaveItemIsVisible)
