...
{
    public class DGVMCComboBoxColumn : DataGridViewComboBoxColumn
    {
        #region "Constructor"

        public DGVMCComboBoxColumn()
        {
            CellTemplate = new DGVMCComboBoxCell();
        }
        #endregion
        #region "Properties"
        ...
        public override sealed DataGridViewCell CellTemplate
        {
            ...
            set
            {
                // Ensure that the cell used for the template is a DGVMCComboBoxCell. 
                if (value != null &&
                    !value.GetType().IsAssignableFrom(typeof(DGVMCComboBoxCell)))
                {
                    throw new InvalidCastException("Must be a DGVMCComboBoxCell");
                }
        ...
        /// <summary>
        /// Replicates the ColumnNames property of the DGVMCComboBoxCell cell type.
        /// </summary>
        ...
        public List<String> ColumnNames
        {
            ...
            set
            {
                ...
                // Update all the existing DGVMCComboBoxCell cells in the column accordingly.
                ...
                for (var rowIndex = 0; rowIndex < rowCount; rowIndex++)
                {
                    ...
                    var dataGridViewCell = dataGridViewRow.Cells[Index] as DGVMCComboBoxCell;
        ...
        /// <summary>
        /// Replicates the ColumnWidths property of the DGVMCComboBoxCell cell type.
        /// </summary>        
        [Category("Data"), DefaultValue("")]
        [Editor("System.Windows.Forms.Design.StringCollectionEditor, System.Design", "System.Drawing.Design.UITypeEditor, System.Drawing")]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        /// <summary>
        /// Replicates the EvenRowsBackColor property of the DGVMCComboBoxCell cell type.
        /// </summary>
        /// 
        /// <returns>
        ...
        /// <summary>
        /// Replicates the OddRowsBackColor property of the DGVMCComboBoxCell cell type.
        /// </summary>
        /// 
        /// <returns>
        ...
        /// <summary>
        /// Small utility function that returns the template cell as a DGVMCComboBoxCell
        /// </summary>
        private DGVMCComboBoxCell MultiColumnComboBoxCellTemplate
        {
            get
            {
                return (DGVMCComboBoxCell)CellTemplate;
            }
        }
        ...
        /// 
        /// <returns>
        /// An <see cref="T:System.Object"/> that represents the cloned <see cref="T:DGMCCBD.Controls.DGVMCComboBoxColumn"/>.
        /// </returns>
        public override object Clone()
        {
            var clone = (DGVMCComboBoxColumn)base.Clone();
        ...
        public override string ToString()
        {
            ...
            sb.Append("DGVMCComboBoxColumn { Name=");
            sb.Append(Name);
            sb.Append(", Index=");
    ...
    public class DGVMCComboBoxCell : DataGridViewComboBoxCell
    {
        ...
        private static Type _defaultEditType = typeof(DGVMCComboBoxEditingControl);
        ...
        /// </summary>
        /// <returns>A Type of <see cref="DGVMCComboBoxEditingControl"/>.</returns>
        public override Type EditType
        {
            get { return _defaultEditType; }
        }
        /// <summary>
        /// The ColumnNames property replicates the one from the DGVMCComboBoxEditingControl control
        /// </summary>
        ...
        /// <summary>
        /// The ColumnWidths property replicates the one from the DGVMCComboBoxEditingControl control
        /// </summary>
        /// <exception cref="T:System.ArgumentNullException">When property is null.</exception>
        public List<String> ColumnWidths
        {
        ...
        /// <summary>
        /// Gets or sets the background color for the even rows portion of the DGVMCComboBoxEditingControl control.  The default is the value of the <see cref="P:System.Windows.Forms.Control.DefaultBackColor"/> property.
        /// </summary>
        /// <returns>
        /// A <see cref="T:System.Drawing.Color"/> that represents the background color of the even rows portion of the DGVMCComboBoxEditingControl.
        /// </returns>
        /// <exception cref="T:System.ArgumentNullException">When property is null.</exception>
        public Color EvenRowsBackColor
        {
        ...
        /// <summary>
        /// Gets or sets the background color for the odd rows portion of the DGVMCComboBoxEditingControl control.  The default is the value of the <see cref="P:System.Windows.Forms.Control.DefaultBackColor"/> property.
        /// </summary>
        /// <returns>
        /// A <see cref="T:System.Drawing.Color"/> that represents the background color of the odd rows portion of the DGVMCComboBoxEditingControl.
        /// </returns>
        /// <exception cref="T:System.ArgumentNullException">When property is null.</exception>
        public Color OddRowsBackColor
        {
        ...
        /// 
        /// <returns>
        /// An <see cref="T:System.Object"/> that represents the cloned <see cref="T:DGMCCBD.Controls.DGVMCComboBoxCell"/>.
        /// </returns>
        public override object Clone()
        {
            var clone = (DGVMCComboBoxCell)base.Clone();
        ...
        /// at the beginning of an editing session. It makes sure that the properties of the DGVMCComboBoxEditingControl editing control are 
        /// set according to the cell properties.
        /// </summary>
        public override void InitializeEditingControl(int rowIndex, object initialFormattedValue, DataGridViewCellStyle dataGridViewCellStyle)
        {
            base.InitializeEditingControl(rowIndex, initialFormattedValue, dataGridViewCellStyle);
            var editingControl = DataGridView.EditingControl as DGVMCComboBoxEditingControl;
        ...
        public override string ToString()
        {
            return string.Format("DGVMCComboBoxCell {{ ColumnIndex={0}, RowIndex={1} }}", ColumnIndex.ToString(CultureInfo.CurrentCulture), RowIndex.ToString(CultureInfo.CurrentCulture));
        }
        /// <summary>
        ...
        /// <summary>
        /// Returns the current DataGridView EditingControl as a DGVMCComboBoxEditingControl control
        /// </summary>
        private DGVMCComboBoxEditingControl EditingMultiColumnComboBox
        {
            get
            {
                return DataGridView.EditingControl as DGVMCComboBoxEditingControl;
            }
        }
        #endregion
    }
    public class DGVMCComboBoxEditingControl : DataGridViewComboBoxEditingControl
    {
        #region "Member Variables"
        ...
        #region "Constructor"
        /// <summary>
        /// Initializes a new instance of the <see cref="T:DGMCCBD.Controls.DGVMCComboBoxEditingControl"/> class.
        /// </summary>
        public DGVMCComboBoxEditingControl()
        {
        ...
        /// </summary>
        public DGVMCComboBoxCell OwnerCell { get; set; }
        #endregion
