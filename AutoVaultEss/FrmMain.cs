    ...
    public partial class FrmMain : Form, iFrmMain
    {
        ...
        private void FrmMain_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                {
                    if (xMessageBox.Show("Do you really want to close Application....?", "Application Exit..!", CCMessageBox.iMessageBoxButtons.YesNo) == DialogResult.No)
                    { e.Cancel = true; }
                    else
                    {
        ...
        {
            lblUserName.Text = StaticInfo.EmployeeName;
            if (!isLoad)
            {
                this.LoadMenu();
        ...
        private void LbtnPurchaeOrder_Paint(object sender, PaintEventArgs e)
        {

        }

        private void LbtnVendorBill_Paint(object sender, PaintEventArgs e)
        {

        }

        private void LbtnVendorPayment_Paint(object sender, PaintEventArgs e)
        {
