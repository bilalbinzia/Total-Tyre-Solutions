...
{
    public partial class ctrDashBoard2 : UserControl
    {

        public ctrDashBoard2()
        {
            InitializeComponent();
            ...
            lblCopyrights.Text = "Powered by Expert System Solutions; Email:info@esspk.com";
            ...
            this.btnWorkOrderNegate.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.btnWorkOrderNegate_LinkClicked);
        ...
        {
            StaticInfo.LoadToControl("AppControls.ctrBookingOrder", "Booking Order", 0);
        }
